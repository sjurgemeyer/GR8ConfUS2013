# Upgrading Grails from 1.x to 2.x
My reveal.js slides for my Gr8Conf 2013 talk on the rigorous process of upgrading your grails app from the 1.x series of versions to the 2.x series, where a significant amount of refactoring was done to the core code.


(below is the original reveal.js README)
